    ...
    <footer className="footer footer-center bg-Beige text-base-content rounded p-10">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://x.com/negaku_salon" target="_blank" >
            <svg
          ...
          <a href="https://www.instagram.com/negaku_salon/?igsh=MTNzOHFocGg1cHlrNA%3D%3D#" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSdf30G72eQoyK6lpGS0wbXRhGSQOrVhWPM0pJfbd0Gv6rmF_Q/viewform" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
