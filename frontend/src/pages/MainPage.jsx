...
const MainPage = () => {
  ...
  return (
    <div>
      <div className="relative w-full h-screen">
        ...
        {/* <div className="absolute inset-0"> */}
          {/* 左上のぼかし模様 */}
          {/* <div
            className="absolute top-10 left-10 w-96 h-96 rounded-full bg-[#637d6e] opacity-70 blur-lg"
          ></div> */}

          {/* 左下のぼかし模様 */}
          {/* <div
            className="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-[#b2bf9f] opacity-70 blur-lg"
          ></div> */}

          {/* 右上のぼかし模様 */}
          {/* <div className="absolute top-10 right-10">
            <div
              className="w-96 h-96 rounded-full bg-[#dcdac4] opacity-70 blur-lg"
            ></div>
          </div> */}

          {/* 右下のぼかし模様 */}
          {/* <div
            className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-[#9ba860] opacity-70 blur-lg"
          ></div>
        </div> */}
    ...
    <div className="relative bg-base-100 p-10">
      {/* 画像とセクションの境目ぼかし */}
      <div className="absolute top-[-20px] left-0 w-full h-12 bg-gradient-to-b from-transparent to-base-100 z-10"></div>
